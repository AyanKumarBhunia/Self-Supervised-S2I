...
if __name__ == '__main__':    
    ...
    parser.add_argument('--path_a', type=str, default='./../Datasets/img_align_celeba', help='path of resource dataset, should be a folder that has one or many sub image folders inside')
